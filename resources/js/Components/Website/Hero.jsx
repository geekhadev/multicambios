    ...
    <section>
      <div className="grid max-w-6xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-6">
          ...
          <a href="#" className="
            inline-flex items-center justify-center px-6 py-3 text-base font-medium text-center text-white rounded-full bg-teal-700
            scale-100 transition duration-300 transform hover:scale-[105%] hover:bg-teal-800
          ">
              Calcula tu envío
