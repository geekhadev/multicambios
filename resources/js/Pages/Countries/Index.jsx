          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg p-3">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className='flex gap-4'>
                <a href={route('dashboard.countries.create')} className="flex items-center gap-1 font-bold bg-blue-600 text-white px-3 py-1 rounded-full hover:bg-blue-700 transition duration-200">
