...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute ha sido comprometido en una filtración de datos. Por favor elige otro.',
    ],
    'present' => 'El campo :attribute debe estar presente.',
    'prohibited' => 'El campo :attribute está prohibido.',
    'prohibited_if' => 'El campo :attribute está prohibido cuando :other sea :value.',
    'prohibited_unless' => 'El campo :attribute está prohibido a menos que :other esté en :values.',
    'prohibits' => 'El campo :attribute prohíbe la presencia del campo :values.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes de error personalizados para atributos
    | usando la convención "attribute.rule" para nombrar las líneas.
    | Por ejemplo, para personalizar el mensaje de error para el atributo "email"
    | con la regla "required", usa "email.required" aquí.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de lenguaje de validación de atributos
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje son utilizadas para intercambiar nombres
    | de atributos de campos de formulario con nombres más amigables para el usuario.
    | Por ejemplo, en lugar de "email", se puede utilizar "dirección de correo electrónico".
    |
    */
